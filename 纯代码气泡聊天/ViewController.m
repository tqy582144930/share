...
//    [self.tableView registerNib:[UINib nibWithNibName:identify bundle:nil] forCellReuseIdentifier:identify];
    ...
    // 底部输入栏
    //这里要改尺寸
    self.inputView = [[MKJInputView alloc] initWithFrame:CGRectMake(0, 736 - 37, 414, 30)];
...
//    }}
    ...
    //这里要改尺寸
    self.tableView.frame = CGRectMake(0, rec.size.height+64, 414, 736 - 75 - rec.size.height - 30);
