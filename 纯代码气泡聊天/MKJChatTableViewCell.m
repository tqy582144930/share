...
//        headImage = [UIImage imageNamed:@"head.JPG"];
        headImage = [UIImage imageNamed:@"40,.png"];
    }
    else // 模拟右边
    {
        //这里要改尺寸
        self.headImageView.frame = CGRectMake(414 - 60, rec.size.height - 18, 50, 50);
        //这里要改尺寸
        self.backView.frame = CGRectMake(414 - 60 - rec.size.width - 20, 10, rec.size.width + 20, rec.size.height + 20);
        
        //
//        image = [UIImage imageNamed:@"bubbleMine"];
        image = [UIImage imageNamed:@"55,.png"];
        
        
        //自己
//        headImage = [UIImage imageNamed:@"naruto@3x"];
        headImage = [UIImage imageNamed:@"39,.png"];
